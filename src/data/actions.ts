...
export const ACTION_REGISTRY: Record<string, ActionDef> = {
  ...
  "action.barbarian.rage": {
    ...
    displayName: "Rage",
    description: "Channel battle fury: for 3 turns gain +2 STR damage and resistance to physical damage (halved). Cannot cast spells while raging. 2 uses per combat.",
    source: "class",
    targetType: "self",
    range: 0,
    charges: 2,
  ...
  "action.ranger.zephyr_strike": {
    ...
    description: "Move with the wind — your next attack roll has advantage, deals +1d8 force damage, and you gain +1 movement this turn.",
    source: "class",
    targetType: "self",
    range: 0,
    resourceType: "spell_slot",
