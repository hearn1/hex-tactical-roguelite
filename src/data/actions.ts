...
export const ACTION_REGISTRY: Record<string, ActionDef> = {
  ...
  "action.paladin.divine_smite": {
    ...
    description: "After landing a melee hit, expend a spell slot to add 2d8 radiant damage to the blow. Triggers as an on-hit rider — does not use a separate action.",
    source: "class",
    targetType: "enemy",
    range: 1,
    timing: "triggered_passive",
    accuracyStat: "str",
    resourceType: "spell_slot",
    slotCost: 1,
    spellLevel: 1,
  ...
  "action.monk.stunning_strike": {
    ...
    description: "After landing a melee hit, spend 1 Ki point to channel ki into the blow — triggers as an on-hit rider. Target must make a CON save (DC 13) or be stunned until your next turn.",
    source: "class",
    targetType: "enemy",
    range: 1,
    timing: "triggered_passive",
