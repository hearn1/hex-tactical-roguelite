...
export const FLAIR_OVERLAYS: Record<string, FlairOverlayDef> = {
  ...
  "overlay.flair.life_domain": { id: "overlay.flair.life_domain", kind: "aura", color: "#a8ffb8" },
  ...
  "overlay.flair.college_of_lore": { id: "overlay.flair.college_of_lore", kind: "aura", color: "#d4a8ff" },
...
export const ARCHETYPE_FLAIR: Record<string, string> = {
  ...
  "archetype.cleric.life_domain": "overlay.flair.life_domain",
  ...
  "archetype.bard.college_of_lore": "overlay.flair.college_of_lore",
